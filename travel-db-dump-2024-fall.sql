...
CREATE TABLE `flagged` (`imageid` int);

CREATE TABLE `deleted` (`imageid` int);
...
VALUES (
        'foo',
        '$2y$12$84Dvzw/j8rH9imMwcWL6lOiI.YoY5AbNjNeN9SVYc2uSLSfkPv6Sm'
    );

INSERT INTO administrator (username, password)
VALUES (
        'jp',
        '$2y$12$KLr0VYwzWjuRsynMnJHRZ.XeOsEuCf19HC9cB4NYnWjhfdZxPjdsm'
    );
